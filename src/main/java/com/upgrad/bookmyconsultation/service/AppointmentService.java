...
public class AppointmentService {
	...
	public String appointment(Appointment appointment) throws SlotUnavailableException, InvalidInputException {
		ValidationUtils.validate(appointment); // Validate the appointment details
		...
		if (existingAppointment.isPresent()) {
			throw new SlotUnavailableException("Appointment slot is already booked");
		}
	...
	public Appointment getAppointment(String appointmentId) {
		...
		return appointment.orElseThrow(ResourceUnAvailableException::new);
	}
